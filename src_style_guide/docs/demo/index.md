...
} = require('../../../src1/components/layout');
const {ReduxFormTextInputComponent, ReduxFormCheckboxInputComponent} = require('../../../src1/components/redux_form');

const {RegularButtonComponent} = require('../../../src1/components/buttons/regular_button_component');
...
const headerComponent = <RegularCardHeaderComponent iconClassNames="fas fa-id-card">Edit user
  data</RegularCardHeaderComponent>;
...
const {ReduxFormGeneratorComponent} = require('../../../src1/components/redux_form');
...
const headerComponent = <RegularCardHeaderComponent iconClassNames="fas fa-window-alt">Edit template
  data</RegularCardHeaderComponent>;
  ...
  [
    {
      ...
      props: {placeholder: 'template name...', label: 'Name', iconClassNames: 'fas fa-window-alt'}
    },
  ...
  [
    {
      ...
      props: {placeholder: 'template directory name...', label: 'Directory name', iconClassNames: 'fas fa-folder'}
    },
...
} = require('../../../src1/components/redux_form');
...
const headerComponent = <RegularCardHeaderComponent iconClassNames="fas fa-globe">Edit domain
  data</RegularCardHeaderComponent>;
...
} = require('../../../src1/components/navigation');
const {RegularCardComponent, RegularCardHeaderComponent} = require('../../../src1/components/layout');
...
class NavigationDemoComponent1 extends Component {
  ...
  render() {
    const headerComponent = <RegularCardHeaderComponent
      iconClassNames="fas fa-id-card">Edit</RegularCardHeaderComponent>;
...
const {RegularButtonComponent} = require('../../../src1/components/buttons');
const {TypewriterVisualEffect} = require('../../../src1/components/visual_effects');

const {SlideVisualEffect} = require('../../../src1/components/visual_effects');
        ...
        >
          <InlineSVGIcon svgViewBox="0 0 60 60" size='extraLarge'>
            <g transform="translate(0,-992.36216)">
              ...
              <path
                d="m 30,1022.3622 c 2.91375,0 5,-2.0412 5,-5 l 0,-2.5 c 0,-2.9587 -2.08625,-5 -5,-5 -2.91375,0 -5,2.0413 -5,5 l 0,2.5 c 0,2.9588 2.08625,5 5,5 z"/>
              <path
                d="m 52.5,1022.3622 c 0,12.4263 -10.07375,22.5 -22.5,22.5 -12.42625,0 -22.5,-10.0737 -22.5,-22.5 0,-12.4262 10.07375,-22.5 22.5,-22.5 12.42625,0 22.5,10.0738 22.5,22.5 z"/>
        ...
        >
          <InlineSVGIcon svgViewBox="0 0 59 58" size='extraLarge'>
            <g transform="translate(0,-993.61216)">
              ...
              <path
                d="m 48.732447,999.8622 c 0,-2.76125 2.23875,-5 5,-5 l -42.5,0 c -2.7612501,0 -5.0000001,2.23875 -5.0000001,5 l 0,46.25 c 0,2.7613 -2.23875,5 -5,5 l 42.5000001,0 c 2.76125,0 5,-2.2387 5,-5 l 0,-46.25 z"/>
              ...
              <path
                d="m 27.482447,1017.3622 0,-2.5 c 0,-1.63 -3.44,-3.75 -6.25,-3.75 -2.81,0 -6.25,2.12 -6.25,3.75 l 0,2.5"/>
              <path
                d="m 21.232447,1002.3622 c -1.93875,0 -3.75,1.4113 -3.75,3.15 l 0,2.4488 c 0,1.74 1.81125,3.1512 3.75,3.1512 1.93875,0 3.75,-1.4112 3.75,-3.1512 l 0,-2.4488 c 0,-1.7387 -1.81125,-3.15 -3.75,-3.15 z"/>
            </g>
          </InlineSVGIcon>
