...
const testData = [
    {label: '.NET', clickable: true},
    {label: 'Android', clickable: true},
    {label: 'C / C++ / Embedded', clickable: true},
    {label: 'Data Sciance', clickable: true},
    {label: 'DBA', clickable: true},
    {label: 'DevOps / Sysadmin', clickable: true},
    {label: 'Fronte-end / JS', clickable: true},
    {label: 'Gamedev / Unity/ AS3', clickable: true},
    {label: 'Golang', clickable: true},
    {label: 'iOS', clickable: true},
    {label: 'Java', clickable: true},
    {label: 'Lead', clickable: true},
    {label: 'Node.js', clickable: true},
    {label: 'PHP', clickable: true},
    {label: 'Product Manager', clickable: true},
    {label: 'Product Manager (PM)', clickable: true},
    {label: 'Python', clickable: true},
    {label: 'Rubu / Rails', clickable: true},
    {label: 'QA Automation', clickable: true},
    {label: 'QA Manual', clickable: true},
    {label: 'Scala', clickable: true},
    {label: 'UX / Design', clickable: true},
    {label: 'Бизнес-аналитика (BA)', clickable: true},
    {label: 'Маркетинг', clickable: true},
    {label: 'Поддержка', clickable: true},
    {label: 'Продажи', clickable: true},
    {label: 'Рекрутеры и HR', clickable: true},
    {label: '(Другие)', clickable: true},
];
