...
const DESKTOP_DISPLAY_HD_MINUS_TYPE: string = 'DESKTOP_DISPLAY_HD_MINUS_TYPE';
const DESKTOP_DISPLAY_HD_TYPE: string = 'DESKTOP_DISPLAY_HD_TYPE';
const DESKTOP_DISPLAY_HD_PLUS_TYPE: string = 'DESKTOP_DISPLAY_HD_PLUS_TYPE';
const DESKTOP_DISPLAY_FULL_HD_TYPE: string = 'DESKTOP_DISPLAY_FULL_HD_TYPE';
const DESKTOP_DISPLAY_4K_TYPE: string = 'DESKTOP_DISPLAY_4K_TYPE';
const DESKTOP_DISPLAY_8K_TYPE: string = 'DESKTOP_DISPLAY_8K_TYPE';
...
const DESKTOP_DISPLAY_HD_MINUS_WIDTH: number = 1280;
const DESKTOP_DISPLAY_HD_WIDTH: number = 1366;
const DESKTOP_DISPLAY_HD_PLUS_WIDTH: number = 1600;
const DESKTOP_DISPLAY_FULL_HD_WIDTH: number = 1920;
const DESKTOP_DISPLAY_4K_WIDTH: number = 3840;
const DESKTOP_DISPLAY_8K_WIDTH: number = 7680;
