...
// local imports
import { MaterialDepthLevelsType, MaterialDepthLevelsFuncType } from './../../../../types/theming/material_depth_level_types';

// implementation
const materialDepthLevelsFunc: MaterialDepthLevelsFuncType = (): MaterialDepthLevelsType => {
...
// exports
export default materialDepthLevelsFunc;
