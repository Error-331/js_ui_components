                ...
                '& > thead': {
                    '& > tr': {
                        '& th': {
                            ...
                            fontFamily: theme.tableStyles.headerFontStack,
    ...
    _createClass(RegularTableComponentClass, [{
        ...
        value: function _renderTableBodyRows() {
            ...
            return (0, _ramda.map)(function (rowData) {
                ...
                var cellsData = (0, _ramda.map)(function (columnData) {
                    ++columnIndex;

                    columnData = _this2._getDataColumn(columnData);
        ...
        value: function _renderTableHeaderCells() {
            ...
            return (0, _ramda.map)(function (columnName) {
                ...
                return React.createElement(
                    'th',
                    {
                        style: { width: _this3._getColumnWidth(columnIndex) },
