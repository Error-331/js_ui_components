    ...
    _createClass(RegularTableClass, [{
        ...
        value: function _prepareColumnData(columnData) {
            return (0, _ramda.cond)([[_ramda.isNil, (0, _ramda.bind)(this._prepareNilColumnData, this)], [function (columnData) {
                ...
                return React.createElement(_form_checkbox_variant3_component.FormCheckboxVariant3Component, { forceCheck: columnData });
        ...
        value: function render() {
            ...
            return (0, _ramda.ifElse)((0, _ramda.equals)(HORIZONTAL_TABLE_TYPE), (0, _ramda.always)(React.createElement(_horizontal_table_component.HorizontalTableComponent, _extends({}, (0, _ramda.omit)(['data', 'classes'], this.props), { data: preparedData }))), (0, _ramda.always)(React.createElement(_vertical_table_component.VerticalTableComponent, _extends({}, (0, _ramda.omit)(['data', 'classes'], this.props), { data: preparedData }))))(this.state.tableType);
        }
