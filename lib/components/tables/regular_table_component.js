...
var styles = function styles(theme) {
    return {
        ...
        regularTextContainer: {
            extend: [(0, _common_styles.commonCellContentStylesFunc)(theme), (0, _common_styles.longTextCellStylesFunc)()],
...
var RegularTableClass = exports.RegularTableClass = (_dec = (0, _reactJss2.default)(styles), _dec(_class = (_temp = _class2 = function (_React$Component) {
    ...
    _createClass(RegularTableClass, [{
        ...
        value: function render() {
            ...
            return (0, _ramda.ifElse)((0, _ramda.equals)(HORIZONTAL_TABLE_TYPE), (0, _ramda.always)(React.createElement(_.HorizontalTableComponent, _extends({}, (0, _ramda.omit)(['data', 'classes'], this.props), { data: data }))), (0, _ramda.always)(React.createElement(_.VerticalTableComponent, _extends({}, (0, _ramda.omit)(['data', 'classes'], this.props), { data: preparedData }))))(this.state.tableType);
        }
