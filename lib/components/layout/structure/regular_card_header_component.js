...
exports.RegularCardHeaderComponent = exports.RegularCardHeaderComponentClass = void 0;
...
// local imports
var _require = require('./regular_panel_component'),
    RegularPanelComponent = _require.RegularPanelComponent; // type definitions
...
var RegularCardHeaderComponentClass =
/*#__PURE__*/
function (_React$Component) {
  ...
  function RegularCardHeaderComponentClass() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(RegularCardHeaderComponentClass).apply(this, arguments));
  }
  ...
  _createClass(RegularCardHeaderComponentClass, [{
    ...
    value: function _getIconClickHandler() {
      return (0, _ramda.defaultTo)(RegularCardHeaderComponentClass.defaultProps.onIconClick)(this.props.onIconClick);
    }
  }, {
    ...
    value: function _renderComponentContainer() {
      return React.createElement(RegularPanelComponent, {
...
exports.RegularCardHeaderComponentClass = RegularCardHeaderComponentClass;

_defineProperty(RegularCardHeaderComponentClass, "displayName", 'RegularCardHeaderComponent');

_defineProperty(RegularCardHeaderComponentClass, "defaultProps", {
  onIconClick: function onIconClick() {}
});

var RegularCardHeaderComponent = (0, _reactJss.default)(styles)(RegularCardHeaderComponentClass);
