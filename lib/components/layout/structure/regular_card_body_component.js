...
exports.RegularCardBodyComponent = void 0;
...
var RegularCardBodyComponent = _decorate([(0, _reactJss.default)(styles)], function (_initialize, _React$Component) {
  var RegularCardBodyComponent =
  /*#__PURE__*/
  function (_React$Component2) {
    _inherits(RegularCardBodyComponent, _React$Component2);
    ...
    function RegularCardBodyComponent() {
      ...
      _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(RegularCardBodyComponent)).call.apply(_getPrototypeOf2, [this].concat(args)));
