...
var RegularCardComponent = exports.RegularCardComponent = (_dec = (0, _reactJss2.default)(styles), _dec(_class = (_temp = _class2 = function (_React$Component) {
    ...
    _createClass(RegularCardComponent, [{
        ...
        value: function _getOuterContainerClasses() {
            ...
            var containerClassNames = (0, _classnames2.default)(this.props.classes.componentContainer, (_classNames = {}, _defineProperty(_classNames, heightClassName, true), _defineProperty(_classNames, poppableClassName, this._getPopOnHover()), _classNames), this.props.containerClassNames);
