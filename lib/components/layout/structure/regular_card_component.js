...
exports.RegularCardComponent = exports.RegularCardComponentClass = undefined;
...
var RegularCardComponentClass = exports.RegularCardComponentClass = function (_React$Component) {
    _inherits(RegularCardComponentClass, _React$Component);

    function RegularCardComponentClass() {
        _classCallCheck(this, RegularCardComponentClass);

        return _possibleConstructorReturn(this, (RegularCardComponentClass.__proto__ || Object.getPrototypeOf(RegularCardComponentClass)).apply(this, arguments));
    }

    _createClass(RegularCardComponentClass, [{
    ...
    return RegularCardComponentClass;
}(React.Component);

// exports


RegularCardComponentClass.displayName = 'RegularCardComponent';
RegularCardComponentClass.defaultProps = {
    containerClassNames: ''
};
var RegularCardComponent = exports.RegularCardComponent = (0, _reactJss2.default)(styles)(RegularCardComponentClass);