...
function ChipCollectionComponent(props) {
  ...
  var elementsRowPositionData = (0, _sections_alignment_hooks.useHorizontalElementsAlignment)($mainContainerRef, theme.layoutStyles.sectionHorizontalSpacing); // endregion
