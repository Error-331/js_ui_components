...
exports.CollapsibleComponent = exports.CollapsibleComponentClass = void 0;
...
function (_React$Component) {
  ...
  function CollapsibleComponentClass(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(CollapsibleComponentClass).call(this, props));

    _defineProperty(_assertThisInitialized(_this), "_outerContainer", void 0);

    _defineProperty(_assertThisInitialized(_this), "_innerContainer", void 0);

    _defineProperty(_assertThisInitialized(_this), "_animationTimeoutId", void 0);
...
exports.CollapsibleComponentClass = CollapsibleComponentClass;

_defineProperty(CollapsibleComponentClass, "displayName", 'CollapsibleComponent');

_defineProperty(CollapsibleComponentClass, "defaultProps", {
...
var CollapsibleComponent = (0, _reactJss.default)(styles)(CollapsibleComponentClass);
