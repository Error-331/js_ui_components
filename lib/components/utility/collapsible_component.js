...
var CollapsibleComponent = function (_React$Component) {
    _inherits(CollapsibleComponent, _React$Component);

    _createClass(CollapsibleComponent, [{
        ...
        value: function render() {
            ...
            var removeContentOnClose = (0, _ramda.defaultTo)(CollapsibleComponent.defaultProps.removeContentOnClose)(this.props.removeContentOnClose);
    ...
    function CollapsibleComponent(props) {
        _classCallCheck(this, CollapsibleComponent);

        var _this = _possibleConstructorReturn(this, (CollapsibleComponent.__proto__ || Object.getPrototypeOf(CollapsibleComponent)).call(this, props));
...
exports.default = (0, _reactJss2.default)(styles)(CollapsibleComponent);