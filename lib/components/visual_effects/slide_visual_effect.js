...
var SlideVisualEffectClass = exports.SlideVisualEffectClass = (_dec = (0, _reactJss2.default)(styles), _dec(_class = (_temp = _class2 = function (_React$Component) {
    ...
    function SlideVisualEffectClass(props) {
        ...
        self._onComponentContainerWidthRead = self._onComponentContainerWidthRead.bind(_this);

        self._getComponentContainerLeftToRightStyle = self._getComponentContainerLeftToRightStyle.bind(_this);
        self._getComponentContainerRightToLeftStyle = self._getComponentContainerRightToLeftStyle.bind(_this);
        self._getComponentContainerBottomToTopStyle = self._getComponentContainerBottomToTopStyle.bind(_this);
        self._getComponentContainerTopToBottomStyle = self._getComponentContainerTopToBottomStyle.bind(_this);
    ...
    _createClass(SlideVisualEffectClass, [{
        ...
        value: function _getComponentContainerClassName() {
            ...
            return (0, _classnames2.default)(this.props.classes.componentContainer, sliderClassName, this.props.className);
        }
    }, {
        ...
        value: function _renderOverlayComponent() {
            return React.createElement(
                ...
                { opacity: this._getOverlayOpacity(), show: true },
