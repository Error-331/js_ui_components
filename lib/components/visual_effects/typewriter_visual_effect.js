...
var TYPEWRITER_VISUAL_EFFECT_ANIMATION_STEP_RATIO = exports.TYPEWRITER_VISUAL_EFFECT_ANIMATION_STEP_RATIO = 0.0875;
var TYPEWRITER_VISUAL_EFFECT_TYPING_FORWARD_KEYFRAMES_STYLE_NAME = exports.TYPEWRITER_VISUAL_EFFECT_TYPING_FORWARD_KEYFRAMES_STYLE_NAME = 'typewriter_visual_effect_typing_forward_keyframes';
var TYPEWRITER_VISUAL_EFFECT_TYPING_BACKWARD_KEYFRAMES_STYLE_NAME = exports.TYPEWRITER_VISUAL_EFFECT_TYPING_BACKWARD_KEYFRAMES_STYLE_NAME = 'typewriter_visual_effect_typing_backward_keyframes';
var TYPEWRITER_VISUAL_EFFECT_CARET_BLINK_KEYFRAMES_STYLE_NAME = exports.TYPEWRITER_VISUAL_EFFECT_CARET_BLINK_KEYFRAMES_STYLE_NAME = 'typewriter_visual_effect_caret_bling_keyframes';

var TYPEWRITER_VISUAL_EFFECT_ANIMATION_STAGE_FORWARD_NAME = exports.TYPEWRITER_VISUAL_EFFECT_ANIMATION_STAGE_FORWARD_NAME = 'forward';
var TYPEWRITER_VISUAL_EFFECT_ANIMATION_STATE_BACKWARD_NAME = exports.TYPEWRITER_VISUAL_EFFECT_ANIMATION_STATE_BACKWARD_NAME = 'backward';
...
var TypewriterVisualEffectClass = exports.TypewriterVisualEffectClass = (_dec = (0, _reactJss2.default)(styles), _dec(_class = (_temp = _class2 = function (_React$Component) {
    ...
    _createClass(TypewriterVisualEffectClass, [{
        ...
        value: function _prepareGlobalKeyframeStyles() {
            ...
            this.props.theme.styleSheetRegister.addGlobalStyles(_defineProperty({}, '@keyframes ' + TYPEWRITER_VISUAL_EFFECT_TYPING_FORWARD_KEYFRAMES_STYLE_NAME, {
                'from': {
                    width: '0%'
                },
                'to': {
            ...
            this.props.theme.styleSheetRegister.addGlobalStyles(_defineProperty({}, '@keyframes ' + TYPEWRITER_VISUAL_EFFECT_TYPING_BACKWARD_KEYFRAMES_STYLE_NAME, {
                'from': {
                    width: '100%'
                },
                'to': {
            ...
            this.props.theme.styleSheetRegister.addGlobalStyles(_defineProperty({}, '@keyframes ' + TYPEWRITER_VISUAL_EFFECT_CARET_BLINK_KEYFRAMES_STYLE_NAME, {
                'from, to': {
