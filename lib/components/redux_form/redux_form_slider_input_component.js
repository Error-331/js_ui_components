...
var _form_slider_input_component = _interopRequireDefault(require("./../form/form_slider_input_component"));
...
function ReduxFormSliderInputComponent(props) {
  var renderComponentContainer = function renderComponentContainer() {
    return _react.default.createElement(_immutable.Field, _extends({
      name: props.name,
      component: _form_slider_input_component.default
    }, props));
  }; // endregion
...
var _default = ReduxFormSliderInputComponent;
