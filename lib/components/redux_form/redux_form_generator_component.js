...
exports.ReduxFormGeneratorClass = void 0;
...
var ReduxFormGeneratorClass = _decorate([(0, _reactJss.default)(styles)], function (_initialize, _React$Component) {
  var ReduxFormGeneratorClass =
  /*#__PURE__*/
  function (_React$Component2) {
    _inherits(ReduxFormGeneratorClass, _React$Component2);
    ...
    function ReduxFormGeneratorClass() {
      ...
      _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ReduxFormGeneratorClass)).call.apply(_getPrototypeOf2, [this].concat(args)));
