...
function (_React$Component) {
  ...
  _createClass(ReduxFormGeneratorClass, [{
    ...
    value: function _prepareInputItem(elm, item, extraProps) {
      var name = item.name,
          hspan = item.hspan,
          vspan = item.vspan;
    ...
    value: function _prepareTextLikeInputItem(elm, item, extraProps) {
      extraProps = (0, _ramda.defaultTo)({})(extraProps);
      return this._prepareInputItem(elm, item, _objectSpread({
    ...
    value: function _prepareItem(item) {
      ...
      switch (type) {
        case 'text':
          return this._prepareTextLikeInputItem(_redux_form_text_input_component.ReduxFormTextInputComponent, item);
        ...
        case 'checkbox':
          return this._prepareInputItem(_redux_form_checkbox_input_component.ReduxFormCheckboxInputComponent, item);

        case 'radio':
          return this._prepareInputItem(_redux_form_radio_button_input_component.ReduxFormRadioButtonInputComponent, item);

        case 'dropdown':
          return this._prepareTextLikeInputItem(_redux_form_drop_down_input_component.ReduxFormDropDownInputComponent, item);

        case 'date':
          return this._prepareTextLikeInputItem(_redux_form_date_input_component.ReduxFormDateInputComponent, item);
