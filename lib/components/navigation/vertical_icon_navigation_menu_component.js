...
exports.VerticalIconNavigationMenuClass = void 0;
...
var VerticalIconNavigationMenuClass = _decorate([(0, _reactJss.default)(styles)], function (_initialize, _React$Component) {
  var VerticalIconNavigationMenuClass =
  /*#__PURE__*/
  function (_React$Component2) {
    _inherits(VerticalIconNavigationMenuClass, _React$Component2);
    ...
    function VerticalIconNavigationMenuClass() {
      ...
      _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(VerticalIconNavigationMenuClass)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  return {
    F: VerticalIconNavigationMenuClass,
    d: [{
      kind: "field",
      static: true,
      key: "displayName",
