...
exports.default = exports.VerticalNavigationMenuClass = void 0;
...
var VerticalNavigationMenuClass = (_dec = (0, _reactJss.default)(styles), _dec(_class = (_temp = _class2 =
/*#__PURE__*/
function (_Component) {
  _inherits(VerticalNavigationMenuClass, _Component);

  _createClass(VerticalNavigationMenuClass, [{
  ...
  function VerticalNavigationMenuClass(props) {
    var _this;

    _classCallCheck(this, VerticalNavigationMenuClass);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(VerticalNavigationMenuClass).call(this, props));
  ...
  return VerticalNavigationMenuClass;
}(_react.Component), _class2.displayName = 'VerticalNavigationMenuClass', _class2.defaultProps = {
  title: '',
  data: []
}, _temp)) || _class);
exports.VerticalNavigationMenuClass = VerticalNavigationMenuClass;

function VerticalNavigationMenuComponent(props) {
  return _react.default.createElement(_main_theme_provider.MainThemeContext.Consumer, null, function (windowDimensions) {
    return _react.default.createElement(VerticalNavigationMenuClass, _extends({}, props, windowDimensions));
  });
}

VerticalNavigationMenuComponent.displayName = 'VerticalNavigationMenuComponent'; // exports

var _default = VerticalNavigationMenuComponent;
