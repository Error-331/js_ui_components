...
var _collapsible_component2 = _interopRequireDefault(_collapsible_component);
...
var VerticalNavigationMenuComponent = function (_Component) {
    _inherits(VerticalNavigationMenuComponent, _Component);

    _createClass(VerticalNavigationMenuComponent, [{
        ...
        value: function _dataElementContainsReactNode(menuElementData) {
            return (0, _design_components.isNotNil)(menuElementData.element);
        }
    }, {
        ...
        value: function _dataElementHasChildren(elementData) {
            ...
            return (0, _ramda.and)((0, _design_components.isNotNil)(children), !(0, _ramda.isEmpty)(children));
        }
    }, {
        ...
        value: function _extractIconClassNames(elementData) {
            return (0, _ramda.cond)([[function (_ref) {
                ...
                return (0, _design_components.isNotNil)(iconClassNames);
            }, function (_ref2) {
        ...
        value: function _createCaptionElement(menuElementData, listElementIndex) {
            ...
            return (0, _ramda.cond)([[function (_ref3) {
                var name = _ref3.name;
                return (0, _design_components.isNotNil)(name);
            }, function (_ref4) {
                var name = _ref4.name;
        ...
        value: function _renderElementsList(data) {
            ...
            var preparedList = indexedMap(function (menuElementData, menuElementIndex) {
                ...
                var $collapsibleChildElementsList = menuElementHasChildren && _react2.default.createElement(
                    _collapsible_component2.default,
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                { title: title, containerClassNames: componentContainer },
                _react2.default.createElement(
                    'nav',
    ...
    function VerticalNavigationMenuComponent(props) {
        _classCallCheck(this, VerticalNavigationMenuComponent);

        var _this = _possibleConstructorReturn(this, (VerticalNavigationMenuComponent.__proto__ || Object.getPrototypeOf(VerticalNavigationMenuComponent)).call(this, props));
    ...
    return VerticalNavigationMenuComponent;
}(_react.Component);

// exports


VerticalNavigationMenuComponent.defaultProps = {
    title: '',
    data: []
};
exports.default = (0, _reactJss2.default)(styles)(VerticalNavigationMenuComponent);