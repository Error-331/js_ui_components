...
function HorizontalIconToolbarComponent(props) {
  ...
  var sectionsRowPositionData = (0, _sections_alignment_hooks.useHorizontalSectionsAlignment)($toolbarRef, theme.layoutStyles.formHorizontalSpacing); // endregion
  ...
  var renderControlGroups = function renderControlGroups(controlSectionData, groupsRowPositionDataData) {
    return (0, _ramda.addIndex)(_ramda.map)(function (controlGroupData, index) {
      var groupRowPositionData = (0, _ramda.defaultTo)({}, groupsRowPositionDataData[index]);
      var ifFirstOnRow = (0, _ramda.defaultTo)(false, groupRowPositionData.isFirst);
      var isLastOnRow = (0, _ramda.defaultTo)(false, groupRowPositionData.isLast);
      var rowNum = (0, _ramda.defaultTo)(false, groupRowPositionData.rowNum);
