...
function HorizontalIconToolbarComponent(props) {
  ...
  var _useState = (0, _react.useState)([]),
      ...
      sectionsFormatData = _useState2[0],
      setSectionsFormatData = _useState2[1]; // endregion
  // region effect hooks declaration


  (0, _react.useEffect)(function () {
    if ((0, _ramda.isNil)($toolbarRef) || (0, _ramda.isNil)($toolbarRef.current)) {
      return;
    }

    var $controlSections = $toolbarRef.current.children;
    var sectionsFormatData = (0, _ramda.map)(function ($controlSection) {
      ...
      var sectionWidth = controlSectionClientRect.width;
      var totalWidth = 0;
      var currentRow = 0;
      var groupFormatData = [];
      (0, _ramda.addIndex)(_ramda.forEach)(function ($controlGroup, controlGroupIndex) {
        ...
        if (controlGroupIndex === 0) {
          ...
          groupFormatData.push({
            isFirst: true,
            rowNum: currentRow
          });
        } else {
          var groupWithWithPadding = groupWidth + theme.layoutStyles.formHorizontalSpacing;
          var totalWidthWithPaddedGroup = groupWithWithPadding + totalWidth;
          var totalWidthWithGroup = groupWidth + totalWidth;
  ...
  var renderControlGroups = function renderControlGroups(controlSectionData, GroupsFormatData) {
    return (0, _ramda.addIndex)(_ramda.map)(function (controlGroupData, index) {
      var groupFormatData = (0, _ramda.defaultTo)({}, GroupsFormatData[index]);
      var ifFirstOnRow = (0, _ramda.defaultTo)(false, groupFormatData.isFirst);
      var isLastOnRow = (0, _ramda.defaultTo)(false, groupFormatData.isLast);
      var rowNum = (0, _ramda.defaultTo)(false, groupFormatData.rowNum);
  ...
  var renderControlSections = function renderControlSections() {
    return (0, _ramda.addIndex)(_ramda.map)(function (controlSectionData, index) {
      var groupFormatData = (0, _ramda.defaultTo)([], sectionsFormatData[index]);
