...
var DraggableCardComponent = _decorate([(0, _reactDnd.DragSource)(function (_ref) {
  var dndType = _ref.dndType;
  return dndType;
}, cardSourceSpec, dragSourceCollector), (0, _reactDnd.DropTarget)(function (_ref2) {
  var dndType = _ref2.dndType;
  return dndType;
}, cardTargetSpec, dragTargetCollector), (0, _reactJss.default)(styles)], function (_initialize, _React$Component) {
  var DraggableCardComponent =
  /*#__PURE__*/
  function (_React$Component2) {
    _inherits(DraggableCardComponent, _React$Component2);
    ...
    function DraggableCardComponent() {
      ...
      _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(DraggableCardComponent)).call.apply(_getPrototypeOf2, [this].concat(args)));
