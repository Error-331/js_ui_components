...
function (_React$Component) {
  ...
  _createClass(ChipClass, [{
    ...
    value: function render() {
      ...
      var componentVariantProps = (0, _ramda.pick)(['variant', 'textType', 'clickable', 'rightIconClickable', 'label', 'labelPosition', 'data', 'disabled', 'onClick', 'onRightIconClick', 'className', 'containerClassName', 'rightIconClassName', 'containerStyle', 'style', 'hoverStyle', 'labelStyle', 'rightIconStyle'], this.props);
