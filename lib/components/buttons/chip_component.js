...
var ChipClass = (_dec = (0, _reactJss.default)(styles), _dec(_class = (_temp = _class2 =
/*#__PURE__*/
function (_React$Component) {
  ...
  function ChipClass(props) {
    ...
    self._clickRightIconHandler = self._clickRightIconHandler.bind(_assertThisInitialized(_this));
  ...
  _createClass(ChipClass, [{
    ...
    key: "_clickRightIconHandler",
    value: function _clickRightIconHandler(event) {
