...
exports.RegularButtonComponent = exports.RegularButtonComponentClass = undefined;
...
var RegularButtonComponentClass = exports.RegularButtonComponentClass = function (_React$Component) {
    _inherits(RegularButtonComponentClass, _React$Component);
    ...
    // region static props
    function RegularButtonComponentClass(props) {
        _classCallCheck(this, RegularButtonComponentClass);

        var _this = _possibleConstructorReturn(this, (RegularButtonComponentClass.__proto__ || Object.getPrototypeOf(RegularButtonComponentClass)).call(this, props));
    ...
    _createClass(RegularButtonComponentClass, [{
    ...
    return RegularButtonComponentClass;
}(React.Component);

// exports


RegularButtonComponentClass.displayName = 'RegularButtonComponent';
RegularButtonComponentClass.defaultProps = {
    label: '',
    className: '',

    onClick: function onClick() {}
};
var RegularButtonComponent = exports.RegularButtonComponent = (0, _reactJss2.default)(styles)(RegularButtonComponentClass);