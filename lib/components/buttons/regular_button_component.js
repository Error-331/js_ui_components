...
var RegularButtonClass = exports.RegularButtonClass = (_dec = (0, _reactJss2.default)(styles), _dec(_class = (_temp = _class2 = function (_React$Component) {
    ...
    _createClass(RegularButtonClass, [{
        ...
        value: function _getComponentContainerClass() {
            ...
            return (0, _classnames2.default)(componentContainer, buttonShape, size, buttonVariant, { 'disabled': this._getDisabled() }, containerClassName, className);
        }
    }, {
        ...
        value: function _getCaptionContainerClass() {
            ...
            return (0, _classnames2.default)(captionContainer, this._getSize(), textType);
        }
        ...
        value: function _getShape() {
            var _props$shape = this.props.shape,
                shape = _props$shape === undefined ? 'rectangular' : _props$shape;
        ...
        value: function _renderIconContainer() {
            ...
            return (0, _ramda.unless)(_ramda.isNil, function (className) {
                return React.createElement(_font_icon.FontIcon, { size: _this2._getSize(), className: className });
        ...
        value: function _renderComponentContainer() {
            ...
            return React.createElement(
                ...
                (0, _ramda.or)((0, _ramda.equals)('left', labelPosition), this._isLabelEmpty()) ? this._renderIconContainer() : null
            );
        }
    }, {
        key: 'render',
