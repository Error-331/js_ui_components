...
var RegularButtonComponentClass = exports.RegularButtonComponentClass = (_temp = _class = function (_React$Component) {
...
}(React.Component), _class.displayName = 'RegularButtonComponent', _class.defaultProps = {
    label: '',
    className: '',
