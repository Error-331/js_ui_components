...
exports.RegularButtonComponent = undefined;
...
var RegularButtonComponent = exports.RegularButtonComponent = (_dec = (0, _reactJss2.default)(styles), _dec(_class = (_temp = _class2 = function (_React$Component) {
    _inherits(RegularButtonComponent, _React$Component);
    ...
    function RegularButtonComponent(props) {
        _classCallCheck(this, RegularButtonComponent);

        var _this = _possibleConstructorReturn(this, (RegularButtonComponent.__proto__ || Object.getPrototypeOf(RegularButtonComponent)).call(this, props));
    ...
    _createClass(RegularButtonComponent, [{
...
}(React.Component), _class2.displayName = 'RegularButtonComponent', _class2.defaultProps = {
    label: '',
    className: '',
