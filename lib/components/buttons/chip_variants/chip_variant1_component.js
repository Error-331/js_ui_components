...
exports.default = exports.ChipVariant1Component = exports.ChipVariant1Class = exports.styles = void 0;
...
var ChipVariant1Class = (_dec = (0, _reactJss.default)(styles, {
  injectTheme: true
}), _dec(_class = (_temp = _class2 =
/*#__PURE__*/
function (_React$Component) {
  _inherits(ChipVariant1Class, _React$Component);
  ...
  // endregion
  // region constructor
  function ChipVariant1Class(props) {
    var _this;

    _classCallCheck(this, ChipVariant1Class);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ChipVariant1Class).call(this, props));
    _this.state = {
  ...
  _createClass(ChipVariant1Class, [{
    ...
    value: function _getRightIconStyle() {
      var iconStyle = (0, _ramda.defaultTo)(ChipVariant1Class.defaultProps.rightIconStyle)(this.props.rightIconStyle);
      return _objectSpread({}, this._getRightIconDisabledStyle(), iconStyle);
    }
  }, {
    key: "_getLabelStyle",
    value: function _getLabelStyle() {
      return (0, _ramda.defaultTo)(ChipVariant1Class.defaultProps.labelStyle)(this.props.labelStyle);
    }
  }, {
    key: "_getData",
    value: function _getData() {
      return (0, _ramda.defaultTo)(ChipVariant1Class.defaultProps.data)(this.props.data);
    }
  }, {
    key: "_getContainerStyle",
    value: function _getContainerStyle() {
      var containerStyles = (0, _ramda.defaultTo)(ChipVariant1Class.defaultProps.containerStyle)(this.props.containerStyle);
      var style = (0, _ramda.defaultTo)(ChipVariant1Class.defaultProps.style)(this.props.style);
    ...
    value: function _getContainerHoverStyle() {
      return (0, _ramda.defaultTo)(ChipVariant1Class.defaultProps.hoverStyle)(this.props.hoverStyle);
    }
  }, {
    key: "_getRightIconClassName",
    value: function _getRightIconClassName() {
      var rightIconClassName = (0, _ramda.defaultTo)(ChipVariant1Class.defaultProps.rightIconClassName)(this.props.rightIconClassName);
    ...
    value: function _isMouseOver() {
      return (0, _ramda.defaultTo)(ChipVariant1Class.defaultState.isMouseOver)(this.state.isMouseOver);
    } // endregion
    ...
    value: function _getClickHandler() {
      return (0, _ramda.defaultTo)(ChipVariant1Class.defaultProps.onClick)(this.props.onClick);
    }
  }, {
    key: "_getClickRightIconHandler",
    value: function _getClickRightIconHandler() {
      return (0, _ramda.defaultTo)(ChipVariant1Class.defaultProps.onRightIconClick)(this.props.onRightIconClick);
    }
  }, {
    key: "_isDisabled",
    value: function _isDisabled() {
      return (0, _ramda.defaultTo)(ChipVariant1Class.defaultProps.disabled)(this.props.disabled);
    }
  }, {
    key: "_getVariant",
    value: function _getVariant() {
      return (0, _ramda.defaultTo)(ChipVariant1Class.defaultProps.variant)(this.props.variant).toLowerCase();
    }
  }, {
    key: "_getTextType",
    value: function _getTextType() {
      return (0, _ramda.defaultTo)(ChipVariant1Class.defaultProps.textType)(this.props.textType).toLowerCase();
    }
  }, {
    key: "_isClickable",
    value: function _isClickable() {
      return (0, _ramda.defaultTo)(ChipVariant1Class.defaultProps.clickable)(this.props.clickable);
    }
  }, {
    key: "_isRightIconClickable",
    value: function _isRightIconClickable() {
      return (0, _ramda.defaultTo)(ChipVariant1Class.defaultProps.rightIconClickable)(this.props.rightIconClickable);
    }
  }, {
    ...
    value: function _getLabelPosition() {
      ...
      return (0, _ramda.unless)(_utility_helpers.isNotNil, (0, _ramda.always)(ChipVariant1Class.defaultProps.labelPosition))(labelPosition);
    }
  }, {
    key: "_getLabel",
    value: function _getLabel() {
      return (0, _ramda.defaultTo)(ChipVariant1Class.defaultProps.label)(this.props.label);
    }
  }, {
    key: "_getLabelSize",
    value: function _getLabelSize() {
      return (0, _ramda.defaultTo)(labelSize)(this.props.labelSize);
    }
  }, {
    key: "_isLabelEmpty",
  ...
  return ChipVariant1Class;
}(React.Component), _class2.displayName = 'ChipVariant1Component', _class2.defaultProps = {
  variant: 'contained',
  textType: 'default',
  clickable: false,
...
exports.ChipVariant1Class = ChipVariant1Class;
var ChipVariant1Component = ChipVariant1Class;
exports.ChipVariant1Component = ChipVariant1Component;
ChipVariant1Component.displayName = 'ChipVariant1Component'; // exports

var _default = ChipVariant1Component;
