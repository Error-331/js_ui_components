...
exports.SimpleFlexGridRow = undefined;
...
function SimpleFlexGridRowFunction(props) {
  ...
  var alignItems = (0, _ramda.defaultTo)('align-items')(yAlign);

  return React.createElement(
    'div',
    { className: componentClassNames, style: _extends({
        flexGrow: flexGrow,
...
// exports
var SimpleFlexGridRow = exports.SimpleFlexGridRow = (0, _reactJss2.default)(styles)(SimpleFlexGridRowFunction);