...
exports.default = exports.FormSwitchInputClass = void 0;
...
var FormSwitchInputClass = (_dec = (0, _reactJss.default)(styles), _dec(_class = (_temp = _class2 =
/*#__PURE__*/
function (_React$Component) {
  _inherits(FormSwitchInputClass, _React$Component);

  // region static props
  // endregion
  // region constructor
  function FormSwitchInputClass(props) {
    var _this;

    _classCallCheck(this, FormSwitchInputClass);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(FormSwitchInputClass).call(this, props));
    _this._id = null;
  ...
  _createClass(FormSwitchInputClass, [{
    ...
    value: function _getInputData() {
      ...
      return (0, _ramda.isNil)(input) ? (0, _ramda.clone)(FormSwitchInputClass.defaultProps.input) : input;
    } // endregion
    // region handlers
    // endregion
  ...
  return FormSwitchInputClass;
}(React.Component), _class2.displayName = 'FormSwitchInputClass', _class2.defaultProps = {
  disabled: false,
  leftLabel: '',
  rightLabel: '',
...
exports.FormSwitchInputClass = FormSwitchInputClass;
...
function FormSwitchInputComponent(props) {
  return React.createElement(_main_theme_provider.MainThemeContext.Consumer, null, function (windowDimensions) {
    return React.createElement(FormSwitchInputClass, _extends({}, props, windowDimensions));
  });
}

FormSwitchInputComponent.displayName = 'FormSwitchInputComponent'; // exports

var _default = FormSwitchInputComponent;
