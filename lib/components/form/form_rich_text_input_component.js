...
function FormRichTextInputComponent(props) {
  ...
  var isSomeBlockHasData = function isSomeBlockHasData(dataKey, dataValue, contentBlocks) {
    return (0, _ramda.any)((0, _ramda.equals)(true), areBlocksHasData(dataKey, dataValue, contentBlocks));
  };

  var isAllBlockHasData = function isAllBlockHasData(dataKey, dataValue, contentBlocks) {
    return (0, _ramda.all)((0, _ramda.equals)(true), areBlocksHasData(dataKey, dataValue, contentBlocks));
  };

  var isNoneBlockHasData = function isNoneBlockHasData(dataKey, dataValue, contentBlocks) {
    return (0, _ramda.none)((0, _ramda.equals)(true), areBlocksHasData(dataKey, dataValue, contentBlocks));
  };

  var isSomeSelectedBlockHasData = function isSomeSelectedBlockHasData(dataKey, dataValue) {
    return isSomeBlockHasData(dataKey, dataValue, getSelectedContentBlocks());
  };

  var isAllSelectedBlockHasData = function isAllSelectedBlockHasData(dataKey, dataValue) {
    return isAllBlockHasData(dataKey, dataValue, getSelectedContentBlocks());
  };

  var isNoneSelectedBlockHasData = function isNoneSelectedBlockHasData(dataKey, dataValue) {
    return isNoneBlockHasData(dataKey, dataValue, getSelectedContentBlocks());
  };
  ...
  var editorToggleBlockType = (0, _ramda.curry)(function (blockDataKey, blockData, event) {
  ...
  var editorToggleInlineStyleHandle = (0, _ramda.curry)(function (inlineStyle, event) {
    ...
    var _draftJSLib2 = draftJSLib,
        RichUtils = _draftJSLib2.RichUtils;
  ...
  var renderAlignmentBlockStylesControls = function renderAlignmentBlockStylesControls() {
    ...
    var controls = (0, _ramda.map)(function (controlData) {
      ...
      return renderControlIcon(className, iconClassName, editorToggleBlockType(BLOCK_ALIGNMENT_DATA_TYPE, blockData), blockData);
  ...
  var renderToolbarsContainer = function renderToolbarsContainer() {
    ...
    }, renderGeneralInlineStylesControls(), renderAlignmentBlockStylesControls(), _react.default.createElement("div", {
      className: controlsGroup
