...
var FormDropDownInputComponentClass = exports.FormDropDownInputComponentClass = function (_React$Component) {
    ...
    _createClass(FormDropDownInputComponentClass, [{
        ...
        value: function _getInputData() {
            ...
            return (0, _ramda.isNil)(input) ? (0, _ramda.clone)(FormDropDownInputComponentClas.defaultProps.input) : input;
        }
    }, {
...
FormDropDownInputComponentClass.displayName = 'FormDropDownInputComponent';
FormDropDownInputComponentClass.defaultProps = {
    readOnly: false,
    disabled: false,
