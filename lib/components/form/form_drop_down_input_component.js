...
var FormDropDownInputClass = (_dec = (0, _reactJss.default)(styles, {
  injectTheme: true
...
function (_React$Component) {
  ...
  _createClass(FormDropDownInputClass, [{
    ...
    value: function _getIconClassName() {
      return (0, _ramda.defaultTo)(FormDropDownInputClass.defaultProps.iconClassName)(this.props.iconClassName);
    }
  }, {
    ...
    value: function _getFormTextInputComponentProps() {
      ...
      var _this$props = this.props,
          ...
          textInputCustomComponent = _this$props.textInputCustomComponent,
