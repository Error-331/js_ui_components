...
exports.FormDropDownInputComponent = exports.FormDropDownInputComponentClass = void 0;
...
var FormDropDownInputComponentClass =
/*#__PURE__*/
function (_React$Component) {
  ...
  function FormDropDownInputComponentClass(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(FormDropDownInputComponentClass).call(this, props));
  ...
  _createClass(FormDropDownInputComponentClass, [{
    ...
    value: function _getInternalSelectedOption() {
      return (0, _ramda.defaultTo)(FormDropDownInputComponentClass.defaultState.selectedOption)(this.state.selectedOption);
    } // endregion
...
exports.FormDropDownInputComponentClass = FormDropDownInputComponentClass;

_defineProperty(FormDropDownInputComponentClass, "displayName", 'FormDropDownInputComponent');

_defineProperty(FormDropDownInputComponentClass, "defaultProps", {
  readOnly: false,
  disabled: false,
  placeholder: '',
  label: '',
...
_defineProperty(FormDropDownInputComponentClass, "defaultState", {
  optionsShown: false,
  selectedOption: null
});

var FormDropDownInputComponent = (0, _reactJss.default)(styles)(FormDropDownInputComponentClass);
