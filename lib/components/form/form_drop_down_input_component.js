...
var FormDropDownInputComponent = function (_React$Component) {
    _inherits(FormDropDownInputComponent, _React$Component);
    ...
    function FormDropDownInputComponent(props) {
        _classCallCheck(this, FormDropDownInputComponent);

        var _this = _possibleConstructorReturn(this, (FormDropDownInputComponent.__proto__ || Object.getPrototypeOf(FormDropDownInputComponent)).call(this, props));
    ...
    _createClass(FormDropDownInputComponent, [{
        ...
        value: function _getInputData() {
            ...
            return (0, _ramda.isNil)(input) ? (0, _ramda.clone)(FormDropDownInputComponent.defaultProps.input) : input;
        }
    }, {
        ...
        value: function _renderTextInputComponent() {
            return React.createElement(_form_text_input_component2.default, this._getFormTextInputComponentProps());
        }
    }, {
        ...
        value: function _renderGlobalOverlayComponent() {
            return React.createElement(_global_overlay_component2.default, { show: this.state.optionsShown, opacity: 0, onOverlayClick: this._onOverlayClick });
        }
    }, {
    ...
    return FormDropDownInputComponent;
}(React.Component);
...
FormDropDownInputComponent.defaultProps = {
    readOnly: false,
    disabled: false,
...
exports.default = (0, _reactJss2.default)(styles)(FormDropDownInputComponent);