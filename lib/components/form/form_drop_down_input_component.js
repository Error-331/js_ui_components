...
var FormDropDownInputComponentClass = exports.FormDropDownInputComponentClass = (_temp = _class = function (_React$Component) {
    ...
    _createClass(FormDropDownInputComponentClass, [{
        ...
        value: function _getOptionContainerClasses(optionValue, optionLabel) {
            return (0, _classnames2.default)(this.props.classes.optionContainer, { 'selected': this._isOptionValueSelected(optionValue, optionLabel) });
        }
    }, {
        ...
        value: function _onOptionClick(event, optionValue, optionLabel) {
            ...
            var _getInputData3 = this._getInputData(),
                onChange = _getInputData3.onChange;

            this.setState({ selectedOption: _defineProperty({}, optionLabel, optionValue) });
