...
function FormTagInputSeparateComponent(props) {
  ...
  var inputProps = (0, _ramda.defaultTo)({}, props.input);
  var containerClassName = (0, _ramda.defaultTo)('', props.className);
  var containerStyle = (0, _ramda.defaultTo)({}, props.style); // endregion
  ...
  var renderTextInput = function renderTextInput() {
    var name = (0, _ramda.pathOr)(null, ['name'], inputProps);
    var initial = (0, _ramda.pathOr)(null, ['initial'], metaProps);
    var value = (0, _ramda.pathOr)(null, ['value'], inputProps);
    var pristine = false;
  ...
  var renderComponentContainer = function renderComponentContainer() {
    ...
    var className = (0, _classnames.default)(componentContainer, containerClassName);
    return _react.default.createElement("div", {
