...
function FormSliderInputComponent(props) {
  ...
  var findNearestGrabbedHandleId = function findNearestGrabbedHandleId(clientX) {
    ...
    }, _ramda.toPairs, (0, _ramda.sortBy)((0, _ramda.pipe)((0, _ramda.prop)(1), (0, _ramda.divide)(_ramda.__, sliderStep), (0, _ramda.subtract)(clientX), Math.abs)), (0, _ramda.nth)(0), (0, _ramda.prop)(0)))(getHandlesData());
  };
  ...
  var calcHandleXPosByUnits = (0, _ramda.pipe)((0, _ramda.divide)(_ramda.__, sliderStep), (0, _ramda.multiply)(unitWidth), Math.round, clampHandleXPos);
  ...
  var containerMouseDownHandler = function containerMouseDownHandler(event) {
    ...
    if (!(0, _ramda.isNil)(nearestGrabbedHandleId)) {
      ...
      var handleValue = currentUnits * sliderStep;
