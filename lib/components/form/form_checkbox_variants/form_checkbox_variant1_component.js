...
var FormCheckboxVariant1ComponentClass = exports.FormCheckboxVariant1ComponentClass = function (_React$Component) {
    ...
    _createClass(FormCheckboxVariant1ComponentClass, [{
        ...
        value: function attachSheet() {
            ...
            var newGlobalStyles = (_newGlobalStyles = {}, _defineProperty(_newGlobalStyles, checkMarkBackgroundContainerStylesName, this._getCheckMarkBackgroundContainerStyles()), _defineProperty(_newGlobalStyles, checkMarkContainerStylesName, this._getCheckMarkContainerStyles()), _defineProperty(_newGlobalStyles, checkMarkBackgroundContainerDisabledStylesName, this._getCheckMarkBackgroundContainerDisabledStyles()), _newGlobalStyles);
        ...
        key: '_getCheckMarkBackgroundContainerStyles',
        value: function _getCheckMarkBackgroundContainerStyles() {
        ...
        key: '_getCheckMarkContainerStyles',
        value: function _getCheckMarkContainerStyles() {
            return {
                visibility: 'visible'
            };
        }
        ...
        key: '_getCheckMarkBackgroundContainerDisabledStyles',
        value: function _getCheckMarkBackgroundContainerDisabledStyles() {
            var theme = this.props.theme;
        ...
        value: function _renderCheckMarkContainer() {
            return React.createElement('div', { className: this._getCheckMarkContainerClasses() });
        }
    }, {
...
FormCheckboxVariant1ComponentClass.displayName = 'FormCheckboxVariant1Component';
FormCheckboxVariant1ComponentClass.defaultProps = {
    disabled: false,
    classes: {}
};
