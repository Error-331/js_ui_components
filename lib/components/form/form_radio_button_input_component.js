...
var FormRadioButtonInputComponent = function (_React$Component) {
    _inherits(FormRadioButtonInputComponent, _React$Component);

    // endregion

    // region constructor
    function FormRadioButtonInputComponent(props) {
        _classCallCheck(this, FormRadioButtonInputComponent);

        var _this = _possibleConstructorReturn(this, (FormRadioButtonInputComponent.__proto__ || Object.getPrototypeOf(FormRadioButtonInputComponent)).call(this, props));
    ...
    _createClass(FormRadioButtonInputComponent, [{
        ...
        value: function _getInputData() {
            ...
            return (0, _ramda.isNil)(input) ? (0, _ramda.clone)(FormRadioButtonInputComponent.defaultProps.input) : input;
        }
    ...
    return FormRadioButtonInputComponent;
}(React.Component);
...
FormRadioButtonInputComponent.defaultProps = {
    disabled: false,
...
exports.default = (0, _reactJss2.default)(styles)(FormRadioButtonInputComponent);