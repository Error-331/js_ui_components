...
var FormTextInputComponent = function (_React$Component) {
    _inherits(FormTextInputComponent, _React$Component);
    ...
    function FormTextInputComponent(props) {
        _classCallCheck(this, FormTextInputComponent);

        var _this = _possibleConstructorReturn(this, (FormTextInputComponent.__proto__ || Object.getPrototypeOf(FormTextInputComponent)).call(this, props));
    ...
    _createClass(FormTextInputComponent, [{
        ...
        value: function _getMetaData() {
            ...
            return (0, _ramda.isNil)(meta) ? (0, _ramda.clone)(FormTextInputComponent.defaultProps.meta) : meta;
        }
    }, {
        key: '_getInputData',
        value: function _getInputData() {
            ...
            return (0, _ramda.isNil)(input) ? (0, _ramda.clone)(FormTextInputComponent.defaultProps.input) : input;
        }
...
exports.default = (0, _reactJss2.default)(styles)(FormTextInputComponent);