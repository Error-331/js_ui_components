...
exports.FormCheckboxInputClass = undefined;
...
var FormCheckboxInputClass = exports.FormCheckboxInputClass = (_dec = (0, _reactJss2.default)(styles), _dec(_class = (_temp = _class2 = function (_React$Component) {
    ...
    function FormCheckboxInputClass(props) {
        ...
        var _this = _possibleConstructorReturn(this, (FormCheckboxInputClass.__proto__ || Object.getPrototypeOf(FormCheckboxInputClass)).call(this, props));
    ...
    _createClass(FormCheckboxInputClass, [{
        ...
        value: function _getLabelClasses() {
            ...
            return (0, _classnames2.default)(this.props.classes.checkboxLabel, variantClassName, (0, _ramda.ifElse)((0, _ramda.equals)('left'), (0, _ramda.always)(checkboxLeftLabel), (0, _ramda.always)(checkboxRightLabel))(labelPosition), { 'disabled': disabled });
        }
    }, {
        ...
        value: function _renderCheckbox() {
            ...
            return (0, _ramda.cond)([[(0, _ramda.equals)(1), function () {
                return React.createElement(_form_checkbox_variant1_component.FormCheckboxVariant1Component, { disabled: _this2.props.disabled, htmlFor: _this2._id });
            }], [(0, _ramda.equals)(2), function () {
                return React.createElement(_form_checkbox_variant2_component.FormCheckboxVariant2Component, { disabled: _this2.props.disabled, htmlFor: _this2._id });
            }], [(0, _ramda.equals)(3), function () {
                return React.createElement(_form_checkbox_variant3_component.FormCheckboxVariant3Component, { disabled: _this2.props.disabled, htmlFor: _this2._id });
            }]])(this._getVariant());
        }
    }, {
        key: '_renderInput',
