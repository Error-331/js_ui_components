...
var FormCheckboxInputComponent = function (_React$Component) {
    _inherits(FormCheckboxInputComponent, _React$Component);

    // endregion

    // region constructor
    function FormCheckboxInputComponent(props) {
        _classCallCheck(this, FormCheckboxInputComponent);

        var _this = _possibleConstructorReturn(this, (FormCheckboxInputComponent.__proto__ || Object.getPrototypeOf(FormCheckboxInputComponent)).call(this, props));
    ...
    _createClass(FormCheckboxInputComponent, [{
        ...
        value: function _getInputData() {
            ...
            return (0, _ramda.isNil)(input) ? (0, _ramda.clone)(FormCheckboxInputComponent.defaultProps.input) : input;
        }
    ...
    return FormCheckboxInputComponent;
}(React.Component);
...
FormCheckboxInputComponent.defaultProps = {
    disabled: false,
...
exports.default = (0, _reactJss2.default)(styles)(FormCheckboxInputComponent);