...
function (_React$Component) {
  ...
  _createClass(FormTextInputVariant1Class, [{
    ...
    value: function _renderTextAreaInput() {
      ...
      var numberOfLines = inputValue.replace(/^\s*[\r\n]/gm, '').split(/\r|\r\n|\n/).length;
    ...
    value: function _renderInput() {
      return (0, _ramda.ifElse)((0, _ramda.equals)('textarea'), this._renderTextAreaInput, this._renderTextInput)(this._getTextInputType());
    }
  }, {
