...
function ResumeCard1Function(props) {
    ...
    currency = (0, _ramda.isNil)(currency) ? '' : currency;
    ...
    noIconClassName = (0, _ramda.isNil)(noIconClassName) ? 'fas fa-address-card' : noIconClassName;

    remote = (0, _ramda.isNil)(remote) ? false : remote;
