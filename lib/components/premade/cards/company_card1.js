...
function CompanyCard1Function(props) {
    ...
    var buttonItems = [[{ elm: _regular_button_component.RegularButtonComponent, props: { shape: 'round', size: 'medium', iconClassName: 'fas fa-search' } }, { elm: _regular_button_component.RegularButtonComponent, props: { shape: 'round', size: 'medium', iconClassName: 'fas fa-pencil' } }, { elm: _regular_button_component.RegularButtonComponent, props: { shape: 'round', size: 'medium', iconClassName: 'fas fa-trash' } }]];
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement(_grid_generator_component.GridGeneratorComponent, { className: classes.buttonsGridContainer, style: { gridTemplateColumns: 'max-content max-content' }, items: buttonItems })
        ),
