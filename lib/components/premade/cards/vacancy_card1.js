...
function VacancyCard1Function(props) {
    ...
    noIconClassName = (0, _ramda.isNil)(noIconClassName) ? 'fas fa-search-dollar' : noIconClassName;
    ...
    return React.createElement(
        ...
        logoSrc ? React.createElement('img', { src: logoSrc, className: classes.companyLogoContainer }) : React.createElement(_font_icon.FontIcon, { size: _general_constants.MEDIUM_SIZE, iconClassName: noIconClassName, className: classes.companyLogoContainer }),
        React.createElement(
