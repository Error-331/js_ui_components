...
function renderElementsGrid(props) {
    ...
    var companyLogoComponent = logoSrc ? React.createElement('img', { src: logoSrc }) : React.createElement(_font_icon.FontIcon, { size: _general_constants.MEDIUM_SIZE, iconClassName: noIconClassName });

    var preparedLocation = '' + (location ? location : '') + (location && remote ? ',' : '') + ' ' + (remote ? 'Remote' : '');

    var bodyItems = [[{ elm: companyLogoComponent, props: { className: classes.companyLogoContainer } }, { elm: _inline_text_block.InlineTextBlock, props: { className: classes.companyNameContainer }, children: company }, { elm: _inline_text_block.InlineTextBlock, props: { className: classes.publishDateContainer }, children: formattedDate }], [{ elm: _inline_header.InlineHeader, hspan: 3, props: { level: 6, className: classes.titleContainer }, children: title }], [{ elm: _inline_text_block.InlineTextBlock, hspan: 2, props: { className: classes.locationContainer }, children: preparedLocation }, { elm: _inline_text_block.InlineTextBlock, props: { className: classes.salaryContainer }, children: salary }]];
