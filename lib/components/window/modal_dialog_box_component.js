...
function (_React$Component) {
  ...
  _createClass(ModalDialogBoxClass, [{
    ...
    key: "_isCloseOnOverlayClick",
    value: function _isCloseOnOverlayClick() {
      return (0, _ramda.defaultTo)(ModalDialogBoxClass.defaultProps.closeOnOverlayClick)(this.props.closeOnOverlayClick);
    }
  }, {
    key: "_isLoading",
    ...
    value: function render() {
      return React.createElement(_modal_component.ModalComponent, {
        ...
        onOverlayClick: this._isClosable() && this._isCloseOnOverlayClick() ? this._getCloseHandler() : undefined,
