...
exports.GlobalOverlayClass = undefined;
...
var GlobalOverlayClass = exports.GlobalOverlayClass = (_dec = (0, _reactJss2.default)(styles), _dec(_class = (_temp = _class2 = function (_React$Component) {
    _inherits(GlobalOverlayClass, _React$Component);

    // endregion

    // region constructor
    function GlobalOverlayClass(props) {
        _classCallCheck(this, GlobalOverlayClass);

        var _this = _possibleConstructorReturn(this, (GlobalOverlayClass.__proto__ || Object.getPrototypeOf(GlobalOverlayClass)).call(this, props));
    ...
    _createClass(GlobalOverlayClass, [{
    ...
    return GlobalOverlayClass;
}(React.Component), _class2.displayName = 'GlobalOverlayClass', _temp)) || _class);
...
function GlobalOverlayComponent(props) {
    return React.createElement(
        ...
        function (windowDimensions) {
            return React.createElement(GlobalOverlayClass, _extends({}, props, windowDimensions));
        }
    );
}
