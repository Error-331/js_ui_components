...
exports.GlobalOverlayComponent = exports.GlobalOverlayComponentClass = undefined;
...
var GlobalOverlayComponentClass = exports.GlobalOverlayComponentClass = (_temp = _class = function (_React$Component) {
    _inherits(GlobalOverlayComponentClass, _React$Component);

    // endregion

    // region constructor
    function GlobalOverlayComponentClass(props) {
        _classCallCheck(this, GlobalOverlayComponentClass);

        var _this = _possibleConstructorReturn(this, (GlobalOverlayComponentClass.__proto__ || Object.getPrototypeOf(GlobalOverlayComponentClass)).call(this, props));
    ...
    _createClass(GlobalOverlayComponentClass, [{
    ...
    return GlobalOverlayComponentClass;
}(React.Component), _class.displayName = 'GlobalOverlayComponent', _temp);

// exports

var GlobalOverlayComponent = exports.GlobalOverlayComponent = (0, _reactJss2.default)(styles)(GlobalOverlayComponentClass);