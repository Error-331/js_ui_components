...
var ModalClass = (_dec = (0, _reactJss.default)(styles, {
  injectTheme: true
...
function (_React$Component) {
  ...
  _createClass(ModalClass, [{
    ...
    value: function _getBodyOuterStyles() {
      ...
      return (0, _ramda.mergeRight)(defaultBodyOuterStyles, userStyles);
    }
  }, {
    key: "_getBodyInnerStyle",
    value: function _getBodyInnerStyle() {
      var userStyles = (0, _ramda.defaultTo)({})(this.props.bodyInnerStyles);
      return (0, _ramda.mergeRight)(defaultBodyInnerStyles, userStyles);
    } // endregion
