...
var ModalClass = _decorate([(0, _reactJss.default)(styles)], function (_initialize, _React$Component) {
  var ModalClass =
  /*#__PURE__*/
  function (_React$Component2) {
    _inherits(ModalClass, _React$Component2);
    ...
    function ModalClass() {
      ...
      _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ModalClass)).call.apply(_getPrototypeOf2, [this].concat(args)));
