...
function (_React$Component) {
  ...
  function OverlayClass(props) {
    ...
    self._onOverlayMouseUp = self._onOverlayMouseUp.bind(_assertThisInitialized(_this));
    self._onOverlayMouseMove = self._onOverlayMouseMove.bind(_assertThisInitialized(_this));
    self._onOverlayMouseLeave = self._onOverlayMouseLeave.bind(_assertThisInitialized(_this));
    _this.state = {
  ...
  _createClass(OverlayClass, [{
    ...
    value: function _onOverlayMouseLeave(event) {
    ...
    value: function _onOverlayMouseMove(event) {
    ...
    value: function _onOverlayMouseUp(event) {
