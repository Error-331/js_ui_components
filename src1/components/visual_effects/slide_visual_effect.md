...
const {ElementsColumn} = require('./index');
...
class TestContainerComponent extends Component {
  ...
  render() {
    ...
    return <div className={this.props.classes.componentContainer} style={this.getContainerStyle()}>
      <SlideVisualEffect onComponentContainerWidthChange={this.onComponentContainerWidthChange}
                         direction={this.props.direction} show={showSlider}>
