...
// local imports
import type {ExtendedEventTargetType, CombinedEventType} from '../../../src/types/dom_types';
...
class SimpleCalendarClass extends React.Component<PropsTypes, StateTypes> {
    ...
    _renderDaysSelectionBodyCell(dayIndex: number, cellText: number | string, isSelected: boolean, currentDayDate?: moment) {
        ...
        const preparedCellText: string = parseInt(cellText) > 9 ? `${cellText}` : `${nbsp}${nbsp}${cellText}`;
