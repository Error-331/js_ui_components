...
const {FormCheckboxInputComponent} = require('./form_checkbox_input_component');
...
<VerticalTableComponent showTableHeader={true} showTableFooter={true} columnNames={columnNames}
                        columnWidths={columnWidths} data={tableData}/>
