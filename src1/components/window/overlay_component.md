...
const {RotatingFontIconPreloader} = require('./index');
...
const headerComponent = <RegularCardHeaderComponent iconClassNames="fas fa-asterisk">Test
  card</RegularCardHeaderComponent>;
